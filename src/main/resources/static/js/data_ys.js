...
const qnaList = [
  {
    q: '1. 이성 사이에 친구가 될 수 있다, 없다?',
    a: [
      // { answer: 'a. 이성 사이에 친구가 어딨어? 절대 없어', type: ['cow', 'tiger', 'dragon', 'chick'] },
      { answer: 'a. 이성간에 친구가 어딨어? 절대 없어', type: ['1', '2', '4', '9'] },
      { answer: 'b. 난 여사친(남사친) 많은데? 절대 이성으로 안보여', type: ['0', '3', '6', '5', '10', '8'] },
      { answer: 'c. 글쎄.. 난 잘 모르겠어..', type: ['7', '11' ] },
    ]
  },
  {
    q: '2. 좋아하는 사람이 생겨 연락 할때 당신은?',
    a: [
      { answer: 'a. 보고싶으면 바로 먼저 연락한다.', type: ['0', '3', '2', '8'] },
      { answer: 'b. 언제 연락할지, 어떻게 말할지 심사숙고한 뒤, 연락한다.', type: ['1', '6', '5', '10'] },
      { answer: 'c. 자존심이 있다. 상대방에게 먼저 연락 올 때까지 기다린다.', type: ['7', '4', '9', '11'] },
    ]
  },
  {
    q: '3. 당신의 고백 스타일은?',
    a: [
      { answer: 'a. 호감이 생기면 바로 고백한다', type: ['1', '3', '2', '10', '8'] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 센스있는 "우리 한번 만나볼래요?" ', type: ['0', '3', '6', '5' ] },
    ]
  },
  {
    q: '5. 연인과 첫 데이트 하는 날! 첫 날 허용할 수 있는 스킨십의 범위는?',
    a: [
      { answer: 'a. 꺅!! 쑥스러워.. 손 잡기 정도??', type: ['1', '7', '10', '4', '9' ] },
      { answer: 'b. 요즘 시대가 어느 때인데, 가벼운 뽀뽀까지 가능하지', type: ['0', '3', '6', '11']},
      { answer: 'c. 왜 스스로 선을 그어? 침대까지도 갈 수 있지!', type: ['2', '5', '8'] },
    ]
  },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 아 그래?? 기다려봐! 나 할 것들 좀만 마무리하고 나갈게', type: ['0', '2', '6', '5' ] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. "아 개빡쳐. 따라오지마 오늘 집 갈 거니까." 라고 말하며 집으로 간다.', type: ['3', '6', '4', '9' ] },
      { answer: 'b. "야! 어이가 없네? 너가 왜 큰소리를 내?" 라고 소리지르며 끝까지 화낸다.', type: ['0', '2', '5', '10', '8'] },
      { answer: 'c. "아니 어쩜 그럴 수 있어..?" 라며 아무말하지 않거나, 조용히 운다.', type: ['1', '7', '11'] },
    ]
  }
]
...
const infoList = [
  {
    name: '연애 뭐 식은 죽 먹기죠, 연애 재능 만땅 <푸들>',
    param: '푸들',
  ...
  {
    name: '야 사귀자, 달려가서 사랑을 쟁취하고야마는 <저먼 셰퍼드>',
    param: '저먼 셰퍼드',
  ...
  {
    name: '이건 어때? 난 어때? 난리부르스의 독특한 매력을 가진 <비글>',
    param: '비글',
  ...
  {
    name: '결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 <보더콜리>',
    param: '보더콜리',
  ...
  {
    name: '기념일에 무슨 이벤트 할까, 이벤트 플래너 <치와와>',
    param: '치와와',
  ...
  {
    name: '어 오늘 머리 바꿨네 잘 어울린다, 센스가 뛰어난 <웰시코기>',
    param: '웰시코기',
  ...
  {
    name: '난 너랑 하는 것들 다 좋아, 순종적인 미소천사 <사모예드>',
    param: '사모예드',
  ...
  {
    name: '난 당신의 연예인, 끼가 넘치는 귀여운 재주꾼 <포메라니안>',
    param: '포메라니안',
  ...
  {
    name: '이건 이거고 저건 저거지 , 말티즈는 참지 않긔! <말티즈>',
    param: '말티즈',
  ...
  {
    name: '난 네가 좋아 너무 좋아, 애교만땅 <비숑 프리제>',
    param: '비숑 프리제',
  ...
  {
    name: '산은 산이요 연애는 연애로다, 느긋하고 온순한 <골든 리트리버>',
    param: '골든 리트리버',
